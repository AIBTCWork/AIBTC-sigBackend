...
var TokenMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_token\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"_signer\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[],\"name\":\"ECDSAInvalidSignature\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"length\",\"type\":\"uint256\"}],\"name\":\"ECDSAInvalidSignatureLength\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"s\",\"type\":\"bytes32\"}],\"name\":\"ECDSAInvalidSignatureS\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"InvalidShortString\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"OwnableInvalidOwner\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"OwnableUnauthorizedAccount\",\"type\":\"error\"},{\"inputs\":[],\"name\":\"ReentrancyGuardReentrantCall\",\"type\":\"error\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"str\",\"type\":\"string\"}],\"name\":\"StringTooLong\",\"type\":\"error\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"nonce\",\"type\":\"uint256\"}],\"name\":\"Claimed\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[],\"name\":\"EIP712DomainChanged\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"oldSigner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newSigner\",\"type\":\"address\"}],\"name\":\"SignerUpdated\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"oldToken\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newToken\",\"type\":\"address\"}],\"name\":\"TokenUpdated\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"balance\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"balanceOf\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"nonce\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"deadline\",\"type\":\"uint256\"},{\"internalType\":\"bytes\",\"name\":\"signature\",\"type\":\"bytes\"}],\"name\":\"claim\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"eip712Domain\",\"outputs\":[{\"internalType\":\"bytes1\",\"name\":\"fields\",\"type\":\"bytes1\"},{\"internalType\":\"string\",\"name\":\"name\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"version\",\"type\":\"string\"},{\"internalType\":\"uint256\",\"name\":\"chainId\",\"type\":\"uint256\"},{\"internalType\":\"address\",\"name\":\"verifyingContract\",\"type\":\"address\"},{\"internalType\":\"bytes32\",\"name\":\"salt\",\"type\":\"bytes32\"},{\"internalType\":\"uint256[]\",\"name\":\"extensions\",\"type\":\"uint256[]\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"emergencyWithdraw\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"nonces\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_newSigner\",\"type\":\"address\"}],\"name\":\"setSigner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"signer\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"token\",\"outputs\":[{\"internalType\":\"contractIERC20\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]",
}
...
func (_Token *TokenCaller) Balance(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "balance")
...
func (_Token *TokenCaller) Signer(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "signer")
...
//
// Solidity: function signer() view returns(address)
func (_Token *TokenSession) Signer() (common.Address, error) {
	return _Token.Contract.Signer(&_Token.CallOpts)
}

// Signer is a free data retrieval call binding the contract method 0x238ac933.
//
// Solidity: function signer() view returns(address)
func (_Token *TokenCallerSession) Signer() (common.Address, error) {
	return _Token.Contract.Signer(&_Token.CallOpts)
}
...
// Claim is a paid mutator transaction binding the contract method 0x6548b7ae.
//
// Solidity: function claim(uint256 amount, uint256 nonce, uint256 deadline, bytes signature) returns()
func (_Token *TokenTransactor) Claim(opts *bind.TransactOpts, amount *big.Int, nonce *big.Int, deadline *big.Int, signature []byte) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "claim", amount, nonce, deadline, signature)
}

// Claim is a paid mutator transaction binding the contract method 0x6548b7ae.
//
// Solidity: function claim(uint256 amount, uint256 nonce, uint256 deadline, bytes signature) returns()
func (_Token *TokenSession) Claim(amount *big.Int, nonce *big.Int, deadline *big.Int, signature []byte) (*types.Transaction, error) {
	return _Token.Contract.Claim(&_Token.TransactOpts, amount, nonce, deadline, signature)
}

// Claim is a paid mutator transaction binding the contract method 0x6548b7ae.
//
// Solidity: function claim(uint256 amount, uint256 nonce, uint256 deadline, bytes signature) returns()
func (_Token *TokenTransactorSession) Claim(amount *big.Int, nonce *big.Int, deadline *big.Int, signature []byte) (*types.Transaction, error) {
	return _Token.Contract.Claim(&_Token.TransactOpts, amount, nonce, deadline, signature)
}
...
func (_Token *TokenTransactor) EmergencyWithdraw(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "emergencyWithdraw")
}

// EmergencyWithdraw is a paid mutator transaction binding the contract method 0xdb2e21bc.
//
// Solidity: function emergencyWithdraw() returns()
func (_Token *TokenSession) EmergencyWithdraw() (*types.Transaction, error) {
	return _Token.Contract.EmergencyWithdraw(&_Token.TransactOpts)
}

// EmergencyWithdraw is a paid mutator transaction binding the contract method 0xdb2e21bc.
//
// Solidity: function emergencyWithdraw() returns()
func (_Token *TokenTransactorSession) EmergencyWithdraw() (*types.Transaction, error) {
	return _Token.Contract.EmergencyWithdraw(&_Token.TransactOpts)
}
...
func (_Token *TokenTransactor) SetSigner(opts *bind.TransactOpts, _newSigner common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "setSigner", _newSigner)
}

// SetSigner is a paid mutator transaction binding the contract method 0x6c19e783.
//
// Solidity: function setSigner(address _newSigner) returns()
func (_Token *TokenSession) SetSigner(_newSigner common.Address) (*types.Transaction, error) {
	return _Token.Contract.SetSigner(&_Token.TransactOpts, _newSigner)
}

// SetSigner is a paid mutator transaction binding the contract method 0x6c19e783.
//
// Solidity: function setSigner(address _newSigner) returns()
func (_Token *TokenTransactorSession) SetSigner(_newSigner common.Address) (*types.Transaction, error) {
	return _Token.Contract.SetSigner(&_Token.TransactOpts, _newSigner)
}
...
// TokenClaimedIterator is returned from FilterClaimed and is used to iterate over the raw logs and unpacked data for Claimed events raised by the Token contract.
type TokenClaimedIterator struct {
	Event *TokenClaimed // Event containing the contract specifics and raw log
...
func (it *TokenClaimedIterator) Next() bool {
...
func (it *TokenClaimedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenClaimedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenClaimed represents a Claimed event raised by the Token contract.
type TokenClaimed struct {
	User   common.Address
	Amount *big.Int
	Nonce  *big.Int
...
//
// Solidity: event Claimed(address indexed user, uint256 amount, uint256 nonce)
func (_Token *TokenFilterer) FilterClaimed(opts *bind.FilterOpts, user []common.Address) (*TokenClaimedIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Claimed", userRule)
	if err != nil {
		return nil, err
	}
	return &TokenClaimedIterator{contract: _Token.contract, event: "Claimed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Claimed(address indexed user, uint256 amount, uint256 nonce)
func (_Token *TokenFilterer) WatchClaimed(opts *bind.WatchOpts, sink chan<- *TokenClaimed, user []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Claimed", userRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenClaimed)
				if err := _Token.contract.UnpackLog(event, "Claimed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Claimed(address indexed user, uint256 amount, uint256 nonce)
func (_Token *TokenFilterer) ParseClaimed(log types.Log) (*TokenClaimed, error) {
	event := new(TokenClaimed)
	if err := _Token.contract.UnpackLog(event, "Claimed", log); err != nil {
		return nil, err
	}
...
func (_Token *TokenFilterer) FilterSignerUpdated(opts *bind.FilterOpts, oldSigner []common.Address, newSigner []common.Address) (*TokenSignerUpdatedIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "SignerUpdated", oldSignerRule, newSignerRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event SignerUpdated(address indexed oldSigner, address indexed newSigner)
func (_Token *TokenFilterer) WatchSignerUpdated(opts *bind.WatchOpts, sink chan<- *TokenSignerUpdated, oldSigner []common.Address, newSigner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "SignerUpdated", oldSignerRule, newSignerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// TokenTokenUpdatedIterator is returned from FilterTokenUpdated and is used to iterate over the raw logs and unpacked data for TokenUpdated events raised by the Token contract.
type TokenTokenUpdatedIterator struct {
	Event *TokenTokenUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenTokenUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenTokenUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenTokenUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenTokenUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenTokenUpdated represents a TokenUpdated event raised by the Token contract.
type TokenTokenUpdated struct {
...
//
// Solidity: event TokenUpdated(address indexed oldToken, address indexed newToken)
func (_Token *TokenFilterer) FilterTokenUpdated(opts *bind.FilterOpts, oldToken []common.Address, newToken []common.Address) (*TokenTokenUpdatedIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "TokenUpdated", oldTokenRule, newTokenRule)
	if err != nil {
		return nil, err
	}
	return &TokenTokenUpdatedIterator{contract: _Token.contract, event: "TokenUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokenUpdated(address indexed oldToken, address indexed newToken)
func (_Token *TokenFilterer) WatchTokenUpdated(opts *bind.WatchOpts, sink chan<- *TokenTokenUpdated, oldToken []common.Address, newToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "TokenUpdated", oldTokenRule, newTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenTokenUpdated)
				if err := _Token.contract.UnpackLog(event, "TokenUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TokenUpdated(address indexed oldToken, address indexed newToken)
func (_Token *TokenFilterer) ParseTokenUpdated(log types.Log) (*TokenTokenUpdated, error) {
	event := new(TokenTokenUpdated)
	if err := _Token.contract.UnpackLog(event, "TokenUpdated", log); err != nil {
		return nil, err
	}
